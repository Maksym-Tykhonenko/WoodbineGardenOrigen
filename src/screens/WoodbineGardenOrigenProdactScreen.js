...
const WoodbineGardenOrigenProdactScreen = ({navigation, route}) => {
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem(
        'SalzburgSecretsOrigenProdactScreen',
        jsonData,
      );
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/back/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/back/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default WoodbineGardenOrigenProdactScreen;
